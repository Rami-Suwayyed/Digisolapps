            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <div class="row">
                        ...
                        @endif
                        @if(isPermissionsAllowed("control-and-view-classes"))
                            <div class="col-md-6 col-lg-3">
                                <a style="  text-decoration: none" href="">
                                    <div class="widget-small danger coloured-icon"><i class="icon fas fa-th-large fa-3x"></i>
                                        <div class="info">
                        ...
                        @endif
                        @if(isPermissionsAllowed("control-website"))
                            <div class="col-md-6 col-lg-3">
                                <a style="  text-decoration: none" href="">
