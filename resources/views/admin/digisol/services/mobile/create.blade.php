...
@section("content")
    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <h3 class="tile-title">{{__("Create Services Mobile")}}</h3>
                <div class="tile-body">
                    <form method="post" action="{{route("admin.digisol.Services.mobile.store")}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
