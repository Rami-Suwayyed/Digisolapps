...
@section("page-title")
    {{__("Digisol Contact Us")}}
@endSection

@section("page-nav-title")
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>  {{__('Digisol Contact')}}</h1>
            <p>{{__('Control and view All Digisol Contact')}}</p>

        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="#">{{__('Digisol Contact')}}</a></li>
        </ul>
    </div>
@endsection
@section("content")
