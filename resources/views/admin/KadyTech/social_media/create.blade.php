...
@section("page-nav-title")
    <div class="app-title">
        <div>
            ...
            <p>{{__("Create  KadyTech Social Media")}}</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="#">{{__("Dashboard")}}</a></li>
            <li class="breadcrumb-item"><a href="{{route("admin.KadyTech.social.index")}}">{{__("Social media")}}</a></li>
    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form method="post" action="{{route("admin.KadyTech.social.store")}}" enctype="multipart/form-data">
