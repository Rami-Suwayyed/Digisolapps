...
@section("page-nav-title")
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>{{__("KadyTech Social Media")}}</h1>
            <p>{{__('All KadyTech Social Media')}}</p>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="buttons-group">
                <a href="{{route("admin.KadyTech.social.create")}}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('Create Social Media')}}</a>
            </div>
            <div class="tile">
                <div class="tile-body">
