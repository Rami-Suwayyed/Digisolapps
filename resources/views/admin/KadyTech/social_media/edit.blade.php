...
@section("page-nav-title")
    <div class="app-title">
        <div>
            ...
            <p>{{__("Edit  KadyTech Social Media")}}</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="#">{{__("Dashboard")}}</a></li>
            <li class="breadcrumb-item"><a href="{{route("admin.KadyTech.social.index")}}">{{__(" KadyTech Social Media")}}</a></li>
...
@section("content")
    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <h3 class="tile-title">{{__("Edit  KadyTech Social media")}}</h3>
                <div class="tile-body">
                    <form method="post" action="{{route("admin.KadyTech.social.update", ["id"=> $socialMedia->id])}}" enctype="multipart/form-data">
