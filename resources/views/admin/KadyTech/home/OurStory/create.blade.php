...
@section("page-nav-title")
    <div class="app-title">
        <div>
            <h1> {{__("OurStory")}}</h1>
            <p>{{__("Create OurStory")}}</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="#">{{__("Dashboard")}}</a></li>
            <li class="breadcrumb-item"><a href="{{route("admin.KadyTech.home.OurStory.index")}}">{{__("OurStory")}}</a></li>
...
@section("content")
    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <h3 class="tile-title">{{__("Create New OurStory")}}</h3>
                <div class="tile-body">
                    <form method="post" action="{{route("admin.KadyTech.home.OurStory.store")}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
