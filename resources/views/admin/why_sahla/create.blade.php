...
@section("page-nav-title")
    <div class="app-title">
        <div>
            <h1> {{__("Why teacher")}}</h1>
            <p>{{__("Create Why teacher")}}</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="#">{{__("Dashboard")}}</a></li>
            <li class="breadcrumb-item"><a href="{{route("admin.digisol.why-teacher.index")}}">{{__("Why teacher")}}</a></li>
...
@section("content")
    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <h3 class="tile-title">{{__("Create New Why teacher")}}</h3>
                <div class="tile-body">
                    <form method="post" action="{{route("admin.digisol.why-teacher.store")}}" enctype="multipart/form-data">
