        ...
        @if(hasPermissions("control-digisol"))
            <li class="treeview @if(request()->routeIs("admin.digisol*")) is-expanded @endif"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-window-maximize"></i><span class="app-menu__label">{{__("Digisol")}}</span><i class="treeview-indicator fa @if(app()->getLocale() == "en") fa-angle-right @else fa-angle-left @endif"></i></a>
                <ul class="treeview-menu">
                   ...
                   <li><a class="treeview-item @if(request()->routeIs("admin.digisol.settings*")) active @endif" href="{{ route("admin.digisol.settings.index") }}"><i class="icon fa fa-envelope"></i> {{__("Digisol settings")}}</a></li>
                    <li><a class="treeview-item @if(request()->routeIs("admin.digisol.apps*")) active @endif" href="{{ route("admin.digisol.apps.index") }}"><i class="icon fa fa-envelope"></i> {{__("Digisol Apps")}}</a></li>
                </ul>
            </li>
        @endif
    </ul>
