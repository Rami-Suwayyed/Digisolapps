...
$("#submitForm").on("click",async function (e){
    ...
    if(response.status_number === "S406"){
        ...
        let experience = response.data.content.experience,
        ...
        let htmlElements = `<div class="card-text category-box">
                                ...
                                <div class="category-link">
                                    ...
                                    <form action='${destroyUrl}' method="post" id="delete${experience.id}" style="display: none" data-swal-title="Delete Type" data-swal-text="Are Your Sure To Delete This Type ?" data-yes="Yes" data-no="No" data-success-msg="the type has been deleted succssfully">
                                        <input type="hidden" name="_token" value="${$('meta[name="csrf-token"]').attr('content')}">
                                        <input type="hidden" name="_method" value="delete">
                                    </form>
                                    <span href="#" class="btn btn-danger control-link form-confirm" style="font-size: 14px" data-form-id="#delete${experience.id}">Delete</span>
                                </div>
                            </div>`;
